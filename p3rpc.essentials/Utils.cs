...
internal class Utils
{
    ...
    {
        _logger.WriteLine($"[P3R Essentials] {message}");
    }

    internal static void LogError(string message, Exception e)
    {
        _logger.WriteLine($"[P3R Essentials] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[P3R Essentials] {message}", System.Drawing.Color.Red);
    }
